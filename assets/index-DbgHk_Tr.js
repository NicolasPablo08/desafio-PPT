(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();function C(){class s extends HTMLElement{constructor(){super(),this.render()}render(){const i=this.attachShadow({mode:"open"}),o=this.getAttribute("variant")||"",e=document.createElement(o==="title"?"h1":o==="body"?"h3":"p");e.classList.add(o),e.textContent=this.textContent;const t=document.createElement("style");t.innerHTML=`
  ...
  `,n==null||n.appendChild(o);const l=document.querySelector(".score__button-game");l==null||l.addEventListener("click",()=>s.goTo("/instructions"));const c=document.querySelector(".score__button-reset");c==null||c.addEventListener("click",()=>{p.clearHistory(),s.goTo("/home")})}const j=[{path:/\/home/,component:V},{path:/\/instructions/,component:P},{path:/\/game/,component:M},{path:/\/confrontation/,component:T},{path:/\/score/,component:H}],m="/desafio-PPT";function h(){return location.host.includes("github.io")}function F(s){function n(o){const e=h()?m+o:o;history.pushState({},"",e),i(e)}function i(o){console.log(" el handleRoute recibio una ruta",o);let e=h()?m+o:o,t=h()?o.replace(m,""):o;if(h()&&t==="/"){e=m+"/home",t="/home";return}s.innerHTML="";for(const a of j)a.path.test(e)?a.component({goTo:n}):console.log("ruta no encontrada")}location.pathname=="/"?n("/home"):i(location.pathname),window.onpopstate=function(){i(location.pathname)}}const x="/desafio-PPT/assets/three-ps-CPfDSeFN.png",k="/desafio-PPT/assets/two-ps-CqS7oaDy.png",q="/desafio-PPT/assets/one-ps-CInDm3eo.png",u="/desafio-PPT/assets/go-ps-Bsl1oJ7i.png";function B(){class s extends HTMLElement{constructor(){super(),this.render()}render(){const i=this.attachShadow({mode:"open"}),o=document.createElement("div");o.classList.add("container__timer");const e=document.createElement("style");let t=4,a=document.createElement("img");a.classList.add("timer__img"),a.src=x;const r=()=>{const l=setInterval(()=>{t--;let c=t>0?t===3?k:t===2?q:u:u;a.src=c,t===0&&(clearInterval(l),this.dispatchEvent(new CustomEvent("timer-finished")))},1e3)};this.addEventListener("timer-restarted",()=>{t=4,a.src=x,r()}),e.innerHTML=`
        .container__timer{
        display: flex;
        flex-direction: column;
        align-items: center;
