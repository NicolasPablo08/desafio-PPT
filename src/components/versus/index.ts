...
import imgPiedra from "../../icons/piedra.svg";
import imgPapel from "../../icons/papel.svg";
import imgTijera from "../../icons/tijera.svg";
    ...
    render() {
      ...
      const imgMachine =
        currentMachineState === "piedra"
          ...
          : imgTijera;
      const imgPlayer =
        currentMyState === "piedra"
          ? imgPiedra
          : currentMyState === "papel"
          ? imgPapel
          : imgTijera;
